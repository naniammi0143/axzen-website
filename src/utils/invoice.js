...
function buildInvoiceHtml(order) {
  ...
  const sellerPayout = valueFromOrder(order, "sellerPayout", "sellerPayoutPaise") || valueFromOrder(order, "sellerPayout", "sellerEarningsPaise");
...
<body>
  <main class="page">
    ...
    <section class="summary">
      ...
      <div><span>Seller payout</span><strong>${money(sellerPayout)}</strong></div>
    ...
    <p class="note">This invoice was generated by Axzen. Delivery charges are shown separately and platform commission is calculated only on the product total.</p>
  </main>
</body>
</html>`;
}
